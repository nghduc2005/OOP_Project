...
public class ChangeProfileStudentPanel extends JPanel {
    MainPanel mainPanel;
    ...
    public ChangeProfileStudentPanel(MainPanel mainPanel) {
...
//        containerPanel.add(saveProfileButton);
    ...
    private void loadProfileData() {
        ...
        SwingWorker<HashMap<String, Object>, Void> worker = new SwingWorker<>() {
            @Override
            protected HashMap<String, Object> doInBackground() throws Exception {
                String query = "select * from students where username = '" + Session.getUsername() + "'";
            ...
            protected void done() {
                try {
                    ...
                    if (map != null) {
                        ...
                        lastNameInput.setText(map.get("last_name") != null ? map.get("last_name").toString() : "");
                        firstNameInput.setText(map.get("first_name") != null ? map.get("first_name").toString() : "");
                        dateOfBirthInput.setText(map.get("dateOfBirth") != null ? map.get("dateOfBirth").toString() : "");
                        emailInput.setText(map.get("email") != null ? map.get("email").toString() : "");
                        phoneNumberInput.setText(map.get("phone") != null ? map.get("phone").toString() : "");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(ChangeProfileStudentPanel.this,
    ...
    public void changeProfile(){
        ...
        if (lastName.isBlank() || firstName.isBlank() || birthday.isBlank() || phone.isBlank() || email.isBlank()){
            JOptionPane.showMessageDialog(
                    app.ui.ChangeProfileStudentPanel.this,
        ...
        SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
            ...
            protected Boolean doInBackground() throws Exception {
                return StudentDao.updateStudent(fullname, birthday, phone, email);
            }
