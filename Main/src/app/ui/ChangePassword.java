...
public class ChangePassword extends JPanel {
    ...
    public ChangePassword(MainPanel mainPanel){
        ...
        Re_enterPasswordLabel.setBounds(W/2-230,H/2-60-y,100,30);
        NewPasswordLabel.setBounds(W/2-230,H/2-20-y,100,30);

        OldPassword.setBounds(W/2-100,H/2-100-y,230,30);
        Re_enterPassword.setBounds(W/2-100,H/2-60-y,230,30);
        NewPassword.setBounds(W/2-100,H/2-20-y,230,30);
    ...
    public void Change(){
        ...
        // mật khảu đúng trong db
        String correct_pw = "abcd";
